...
print("✅ Created clean planner.py without duplicate enum values")
print("Now test it:")
print("python -c \"from agents.planner import StepType; print([e.value for e in StepType])\"")