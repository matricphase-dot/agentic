"""
Phase 6 Test - Researcher Agent Integration (Fixed)
"""
...
def test_orchestrator_with_researcher():
    ...
    try:
        ...
        try:
            ...
            print(f"[FAILED] Name error (missing class): {e}")
            return False
        ...
        print(f"[SUCCESS] Agent status: {status}")
...
def test_end_to_end_workflow():
    ...
    try:
        ...
        # First try to import orchestrator
        try:
            from agents.orchestrator_v5_3 import ToolEnhancedOrchestrator
        except (ImportError, NameError) as e:
            print(f"[SKIPPED] Orchestrator not available: {e}")
            ...
            print("[SUCCESS] Agents created (planner, researcher)")
            ...
            if result.get("success"):
                ...
                print(f"[FAILED] Research failed: {result.get('error')}")
                return False
...
def main():
    ...
    print("PHASE 6 - RESEARCHER AGENT INTEGRATION TEST (FIXED)")
    print("=" * 70)
