...
print("✅ Created clean orchestrator_v5_3.py")
print("Now test it: python -c \"from agents.orchestrator_v5_3 import ToolEnhancedOrchestrator; print('Import successful')\"")