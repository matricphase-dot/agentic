# fix_phase6.py
"""
Quick fix for Phase 6 - EnhancedWorkflowResult not defined
"""

import os

print("=" * 70)
print("FIXING PHASE 6 - EnhancedWorkflowResult ERROR")
print("=" * 70)

# Create the complete orchestrator_v5_3.py
orchestrator_code = '''"""
...
# Write the fixed orchestrator file
os.makedirs("agents", exist_ok=True)
with open("agents/orchestrator_v5_3.py", "w", encoding='utf-8') as f:
    f.write(orchestrator_code)

print("[OK] Created complete orchestrator_v5_3.py with EnhancedWorkflowResult")

# Test the imports
print("\n[TEST] Testing imports...")
try:
    from agents.orchestrator_v5_3 import ToolEnhancedOrchestrator, EnhancedWorkflowResult
    print("[SUCCESS] ToolEnhancedOrchestrator imported")
    print("[SUCCESS] EnhancedWorkflowResult imported")
    
    # Test creating an instance
    orchestrator = ToolEnhancedOrchestrator(use_gemini=False)
    result = orchestrator.execute_workflow("Test")
    
    print(f"[SUCCESS] Orchestrator created and executed workflow")
    print(f"  Workflow ID: {result.workflow_id}")
    print(f"  Status: {result.overall_status}")
    print(f"  Has total_duration: {hasattr(result, 'total_duration')}")
    
except Exception as e:
    print(f"[FAILED] Error: {e}")

print("\n" + "=" * 70)
print("[SUCCESS] Phase 6 fix applied")
print("=" * 70)
print("\nNow run the fixed test:")
print("  python test_phase6_researcher_fixed.py")