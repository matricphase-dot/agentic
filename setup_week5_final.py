# setup_week5_final.py
"""
Fixed setup script for Week 5 - No emojis for Windows compatibility
"""
...
def install_dependencies():
    ...
    if success:
        ...
        print("[WARNING] Some dependencies may not be installed properly")
...
'''
    ...
    print("[OK] Created agents/researcher.py")
    return True
...
'''
    ...
    with open("tools/web_scraper.py", "w", encoding='utf-8') as f:
        f.write(web_scraper_code)
    
    print("[OK] Created tools/web_scraper.py")
    return True
...
'''
    ...
    with open("test_phase6_researcher.py", "w", encoding='utf-8') as f:
        f.write(test_code)
    
    print("[OK] Created test_phase6_researcher.py")
    return True
...
def verify_setup():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("[WARNING] Network test returned non-200 status")
            
    except Exception as e:
        print(f"[FAILED] Setup verification failed: {e}")
        return False
...
def main():
    ...
    if all_ok:
        print("[SUCCESS] WEEK 5 SETUP COMPLETE!")
        ...
        print("\nQuick test commands:")
        print("  python -c \"from agents.researcher import ResearcherAgent; r=ResearcherAgent(); print('[OK] Researcher ready!')\"")
        print("  python -c \"from tools.web_scraper import WebScraper; s=WebScraper(); print('[OK] WebScraper ready!')\"")
    else:
